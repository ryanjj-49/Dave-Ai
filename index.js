...
const {  state, saveCreds } =await useMultiFileAuthState(`./session`)
  ...
  if (!DaveAi.authState.creds.registered && (!config.SESSION_ID || config.SESSION_ID === "")) {
    try {
      ...
      console.log(chalk.green(`Enter this code on your phone to pair: ${pairCode}`));
      console.log(chalk.yellow("Wait a few seconds and approve the pairing on your phone..."));
    } catch (err) {
